...
/**
 * [ESS] โมดัลยื่นคำขอลาด้วยตนเอง — พนักงานยื่นคำขอลาให้ตัวเองเท่านั้น
 * (ต่างจาก LeaveRequestModal ของฝั่ง HR ที่เลือกยื่นแทนพนักงานคนอื่นได้)
 */
export const MyLeaveRequestModal: React.FC<MyLeaveRequestModalProps> = ({
  isOpen,
  onClose,
  leaveTypes,
  leavePolicies,
